...
- **Ningk**：深色石墨界面，蓝色强调色，适合夜间和长时间编码。
- **Ningk Light**：偏暖的纸面浅色界面，适合阅读、笔记和白天工作。

## 特性

- 一个扩展同时提供深色和浅色两套主题。
- 调整了 Activity Bar、Side Bar、Panel、Tab、List、Input、Button、Notification、Status Bar 等 VS Code 工作区颜色。
- 启用语义高亮。
- 对 Markdown 的标题、链接、引用、代码块和强调文本做了专门配色。
- 深色和浅色主题共享相近的语法颜色逻辑，切换时视觉语言保持一致。

## 具体修改内容

- 不只修改编辑器 token 颜色，也调整了完整 VS Code 工作区配色。
